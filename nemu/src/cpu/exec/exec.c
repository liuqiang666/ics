...
opcode_entry opcode_table [512] = {
  ...
  /* 0x40 */	IDEXW(r, inc, 1), IDEX(r, inc), IDEXW(r, inc, 1), IDEX(r, inc),
  /* 0x44 */	IDEXW(r, inc, 1), IDEX(r, inc), EMPTY, EMPTY,
  /* 0x48 */	IDEXW(r, dec, 1), IDEX(r, dec), IDEXW(r, dec, 1), IDEX(r, dec),
  /* 0x4c */	IDEXW(r, dec, 1), IDEX(r, dec), EMPTY, EMPTY,
